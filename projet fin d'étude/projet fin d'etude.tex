...
\begin{document}
	...
	\etocsettocstyle{{\large\bfseries\color{cafeeNavy}Sommaire\par\medskip}}{{\vspace{4pt}\color{primaryPurple}\hrule height 1pt\vspace{12pt}}}
	...
	\begin{enumerate}[label={[\arabic*]}, leftmargin=1.5cm]
		...
		\item Muslim Pro : \url{https://www.muslimpro.com} (consulté le 01/02/2025).
		
		\item Salam Planet : \url{https://salamplanet.com} (consulté le 01/02/2025).
		
		\item Flutter : \url{https://flutter.dev/docs} (consulté le 15/02/2025).
		
		\item Dart : \url{https://dart.dev/guides} (consulté le 15/02/2025).
		
		\item Node.js : \url{https://nodejs.org/en/docs} (consulté le 01/03/2025).
		
		\item Express.js : \url{https://expressjs.com} (consulté le 01/03/2025).
		
		\item MongoDB : \url{https://www.mongodb.com/docs} (consulté le 01/03/2025).
		
		\item Mongoose : \url{https://mongoosejs.com/docs} (consulté le 01/03/2025).
		
		\item JWT : \url{https://jwt.io/introduction} (consulté le 10/03/2025).
		
		\item bcryptjs : \url{https://www.npmjs.com/package/bcryptjs} (consulté le 10/03/2025).
		
		\item Helmet.js : \url{https://helmetjs.github.io} (consulté le 10/03/2025).
		
		\item Swagger UI : \url{https://swagger.io/tools/swagger-ui} (consulté le 15/03/2025).
		
		\item Material Design 3 : \url{https://m3.material.io} (consulté le 15/03/2025).
		
		\item SCRUM : \url{https://www.scrum.org/resources/scrum-guide} (consulté le 20/03/2025).
		
		\item Cycle en V : \url{https://www.manager-go.com/gestion-de-projet/cycle-en-v.htm} (consulté le 20/03/2025).
		
		\item 2TUP : \url{https://www.techno-science.net/definition/670.html} (consulté le 20/03/2025).
		
		\item UML : \url{https://www.lucidchart.com/pages/fr/langage-uml} (consulté le 01/04/2025).
		
		\item Diagramme de séquence : \url{https://www.lucidchart.com/pages/fr/diagramme-de-sequence-uml} (consulté le 01/04/2025).
		
		\item draw.io : \url{https://www.drawio.com} (consulté le 01/04/2025).
		
		\item Visual Studio Code : \url{https://code.visualstudio.com} (consulté le 10/04/2025).
		
		\item Android Studio : \url{https://developer.android.com/studio} (consulté le 10/04/2025).
		
		\item Postman : \url{https://www.postman.com} (consulté le 10/04/2025).
		
		\item MongoDB Compass : \url{https://www.mongodb.com/products/compass} (consulté le 10/04/2025).
		
		\item GitHub : \url{https://github.com} (consulté le 15/04/2025).
		
		\item Overleaf : \url{https://www.overleaf.com} (consulté le 20/04/2025).
		
	\end{enumerate}
\newpage
\thispagestyle{fancy}

\begin{tcolorbox}[enhanced,colback=white,colframe=cafeeNavy,boxrule=1pt,arc=4pt,left=10pt,right=10pt,top=10pt,bottom=10pt]
	\textbf{\large Résumé :}
	
	\medskip
	
	Ce travail a été réalisé au sein de \textbf{Cafee Agency}. Il s'inscrit dans le cadre du projet de fin d'études en vue de l'obtention 
	du diplôme de \textbf{Licence en Génie Logiciel et Systèmes d'Information} de 
	l'Institut Supérieur d'Informatique et de Gestion de Kairouan. Il consiste à 
	concevoir et développer \textbf{Soeurise}, une plateforme communautaire mobile et 
	web dédiée aux femmes musulmanes, en se basant sur les technologies : 
	\textbf{Flutter}, \textbf{Dart}, \textbf{Node.js}, \textbf{Express.js} et 
	\textbf{MongoDB}.
	
	\medskip
	
	\textbf{Mots-clés :} Plateforme communautaire, femmes musulmanes, réseau social, 
	masterclasses, événements, Flutter, Node.js, MongoDB, API RESTful, authentification JWT.
\end{tcolorbox}

\vspace{1cm}

\begin{tcolorbox}[enhanced,colback=white,colframe=primaryPurple,boxrule=1pt,arc=4pt,left=10pt,right=10pt,top=10pt,bottom=10pt]
	\textbf{\large Abstract :}
	
	\medskip
	
	This work was carried out within \textbf{Cafee Agency}. It is part of the end-of-study project for the graduation 
	of the \textbf{Bachelor's degree in Software Engineering and Information Systems} 
	at the Institut Supérieur d'Informatique et de Gestion de Kairouan. It consists 
	in designing and developing \textbf{Soeurise}, a mobile and web community platform 
	dedicated to Muslim women, based on the following technologies: \textbf{Flutter}, 
	\textbf{Dart}, \textbf{Node.js}, \textbf{Express.js} and \textbf{MongoDB}.
	
	\medskip
	
	\textbf{Keywords :} Community platform, Muslim women, social network, masterclasses, 
	events, Flutter, Node.js, MongoDB, RESTful API, JWT authentication.
\end{tcolorbox}
\end{document}