...
class ProfileService {
  ...
  void setFromUser(User user) async {
    ...
    // Persist current_user_id for other services (like MessageService)
      ...
      if (res.success) {
        ...
        if (userMap != null) {
          ...
          profile.value = Profile(
            ...
            profileImageLocalPath: p.profileImageLocalPath,
  ...
  /// On Web, pass [fileBytes] and [fileName].
  Future<(bool, String?)> updateAvatarWithError(
    String? filePath, {
    List<int>? fileBytes,
    String? fileName,
  }) async {
