...
class _StoryViewerScreenState extends State<StoryViewerScreen>
  ...
  static const Duration _defaultStoryDuration = Duration(seconds: 10);
  ...
  void _resumeStory() {
    if (_isSendingReply) return; // Don't resume if still replying (though usually keyboard blocks)
