                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      if (picked != null) {
                        setState(() {
                          tempAvatarPath = picked.path; // Preview using blob URL or path
                        ...
                        if (kIsWeb) {
                          ...
                          final (s, e) = await ProfileService.instance.updateAvatarWithError(
                            null,
                            fileBytes: bytes,
                    ...
                    builder: (context, profile, child) {
                      return Column(
                        ...
                        children: [
                          ...
                          const FadeSlideIn(
                            child: CurrentUserAvatar(radius: 50),
                          ),
                          const SizedBox(height: 16),
